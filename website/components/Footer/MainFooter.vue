<template>
  <div class='footer bg-primary-dark text-white'>
    <div class='container mx-auto flex justify-between gap-5 py-8'>
      <div class='widget1 flex-1'>
        <div class='logo mb-5'>
          <img src='/assets/images/logo white.svg' alt='Logo'>
        </div>
        <p class='mb-5 text-justify'>In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document or a typeface without</p>
      ...
      <div class='widget2 flex-1'></div>
      <div class='widget3 flex-1'></div>
    </div>
    <pre-footer />
  </div>
</template>

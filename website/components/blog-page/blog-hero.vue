<template>
  <div class="blog-hero min-h-screen mb-8 flex justify-center items-center">
    ...
    >
      <div class="backdrop w-full h-full p-8 rounded-xl text-white h-full">
        <h1 class="font-bold text-5xl lg:text-7xl text-center uppercase mb-5">
          Blog
        </h1>
        <h2 class="font-bold text-xl lg:text-3xl text-center">
          Your Query Search Here
        </h2>
        ...
        <div
          :class="{ 'visibility-hidden opacity-0 ': search }"
